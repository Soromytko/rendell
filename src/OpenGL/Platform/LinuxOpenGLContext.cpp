...
bool LinuxOpenGLContext::createContext(int majorVersion, int minorVersion) {
    int fbConfigAttribs[] = {GLX_X_RENDERABLE,
                             True,
                             GLX_DRAWABLE_TYPE,
                             GLX_WINDOW_BIT,
                             GLX_RENDER_TYPE,
    ...
    GLXFBConfig *fbConfigs =
        glXChooseFBConfig(_display, DefaultScreen(_display), fbConfigAttribs, &fbCount);
    ...
    typedef GLXContext (*glXCreateContextAttribsARBProc)(Display *, GLXFBConfig, GLXContext, Bool,
                                                         const int *);
    auto glXCreateContextAttribsARB = (glXCreateContextAttribsARBProc)glXGetProcAddressARB(
